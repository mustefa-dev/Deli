...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Deli.Entities.AppUser", b =>
                {
                    ...
                    b.Property<bool?>("IsSubbedToNews")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Deli.Entities.DiscoverDeli", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RedirectButton")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Deli.Entities.ItemTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Deli.Entities.NewsSubscribedUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Deli.Entities.Package", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Deli.Entities.QualityTools", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Deli.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Deli.Entities.WhoAreWe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Deli.Entities.Item", b =>
                {
                    ...
                    b.HasOne("Deli.Entities.Package", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Deli.Entities.ItemTag", b =>
                {
                    ...
                    b.HasOne("Deli.Entities.Tag", "Tag")
                        .WithMany("ItemTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
