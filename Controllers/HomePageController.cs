...
public class HomePageController : BaseController
{
    ...
    public async Task<ActionResult<DiscoverDeliDto>> GetDiscoverDeli() => Ok(await _homepageServices.GetDiscoverDeli());
    ...
    [HttpGet("WhoAreWe")]
    public async Task<ActionResult<WhoAreWeDto>> GetMyWhoAreWe() => Ok(await _homepageServices.GetMyWhoAreWe());
    [HttpPut("WhoAreWe{id}")]
